    ...
    <div className="fixed inset-0 z-40 h-screen w-full flex flex-col bg-[#141111] overflow-hidden font-sans select-none animate-in fade-in duration-200">
      ...
      <div className="w-full bg-[#141111] pt-14 px-6 pb-6 flex flex-col items-center relative select-none shrink-0">
        ...
        <div className="w-full flex justify-between items-center mb-3">
          ...
          {/* Right side: Edit SVG Icon (No Action / Popup) */}
      ...
      <div className="w-full flex-1 bg-white rounded-t-[36px] px-6 pt-5 pb-28 flex flex-col gap-6 relative shadow-[0_-12px_35px_rgba(0,0,0,0.15)] overflow-y-auto no-scrollbar min-h-0 text-zinc-900">
        {/* Sheet Drag Handle */}
        <div className="w-10 h-1 bg-zinc-200 rounded-full mx-auto -mt-1 mb-1 shrink-0" />

        {/* ── Followers & Following Fully Round Capsules ── */}
        ...
        {isSelf && (
          <div className="mt-auto mb-4">
            <button
              ...
              className="w-full py-3.5 rounded-full bg-rose-50 hover:bg-rose-100 text-rose-600 font-semibold text-[13.5px] flex items-center justify-center gap-2 transition-colors cursor-pointer active:scale-[0.99] outline-none border-0"
            >
