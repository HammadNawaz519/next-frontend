...
export default function WebcamASL({ isCallActive = false }: WebcamASLProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col min-h-0 select-none bg-transparent">
      ...
      {/* ── 2-Column Professional Workspace ── */}
      <div className="flex-grow flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-5 gap-6 p-6 lg:p-8">
        
        {/* Left Area (3/5ths width): Video Feed & Document Output Canvas */}
        <div className="lg:col-span-3 flex flex-col gap-6 min-h-0">
          
          {/* Camera Frame */}
          <div
            className="flex-grow flex-2 min-h-[300px] w-full relative bg-zinc-950 rounded-3xl overflow-hidden transition-all duration-500 shadow-md flex flex-col items-center justify-center border animate-in fade-in duration-500"
            style={{ 
          ...
          <div 
            className="flex-grow flex-1 min-h-[160px] max-h-[220px] w-full rounded-3xl p-6 border flex flex-col relative"
          ...
          >
            ...
            <div className="flex-grow flex-1 overflow-y-auto pr-1 min-h-0 flex items-start justify-start">
              <p
        ...
        {/* Right Area (2/5ths width): Elegant AI Intelligence & Analytics Sidebar */}
        <div className="lg:col-span-2 flex flex-col gap-6 min-h-0">
          
          {/* Main AI Diagnostics HUD */}
          <div
            className="flex-grow flex-1 min-h-0 rounded-3xl p-6 flex flex-col items-center justify-center gap-6 border relative overflow-hidden"
            style={{ 
          ...
          >
            ...
            <div className="flex flex-col items-center gap-2 mt-4">
              <div 
                className="w-24 h-24 rounded-full border flex items-center justify-center text-4xl font-black shadow-inner transition-all duration-300"
                style={{ 
          ...
          <div className="rounded-3xl p-5 border flex-shrink-0" style={{ background: 'var(--dm-bg-hover)', borderColor: 'var(--dm-border)' }}>
          ...
          <div className="rounded-3xl p-5 border flex-shrink-0" style={{ background: 'var(--dm-bg-hover)', borderColor: 'var(--dm-border)' }}>
            <p className="text-[8px] font-mono font-bold uppercase tracking-[0.2em] mb-4" style={{ color: 'var(--dm-text-secondary)' }}>
              ...
              <div className="space-y-3.5">
                {result.top3.map((item, i) => (
                  <div key={item.label} className="flex items-center gap-3">
                    <span
                      className="w-4.5 h-4.5 rounded-md flex items-center justify-center text-[8px] font-mono font-bold"
                      style={{
              ...
              <div className="space-y-3.5 opacity-30">
                {[1, 2, 3].map((idx) => (
                  <div key={idx} className="flex items-center gap-3">
                    <span className="w-4.5 h-4.5 rounded-md flex items-center justify-center text-[8px] font-mono font-bold bg-zinc-900 text-zinc-600 border border-zinc-800">
                      0{idx}
                    </span>
          ...
          <div className="grid grid-cols-2 gap-3 flex-shrink-0 z-10">
            ...
            <button
              ...
              disabled={!sentence}
              className="py-3.5 px-4 rounded-2xl text-[10px] font-mono uppercase tracking-wider font-semibold transition-all active:scale-95 disabled:opacity-40 flex items-center justify-center gap-2 cursor-pointer border"
              style={{ 
