...
export const INSTAGRAM_THEMES: ChatTheme[] = [
  ...
  { id: 'sea-side', name: 'Sea Side', category: 'Special', outgoingGradient: 'linear-gradient(135deg, #0ea5e9 0%, #0284c7 50%, #0369a1 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: '#50072d', incomingTextColor: '#fdf2f8', chatBg: 'transparent', accentColor: '#f472b6', inputBorderColor: '#38bdf8', reactionAccent: '#f472b6', previewWallpaper: '/sea-side.jpg', wallpaperUrl: '/sea-side.jpg' },
];
