...
export const INSTAGRAM_THEMES: ChatTheme[] = [
  ...
  { id: 'hearts', name: 'Hearts', category: 'Special', outgoingGradient: 'linear-gradient(135deg, #be185d 0%, #831843 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'rgba(253, 232, 241, 0.92)', incomingTextColor: '#701a40', chatBg: 'transparent', accentColor: '#be185d', inputBorderColor: '#be185d', reactionAccent: '#be185d', previewWallpaper: '/Hearts.jpg', wallpaperUrl: '/Hearts.jpg' },
  { id: 'floral', name: 'Floral', category: 'Special', outgoingGradient: 'linear-gradient(135deg, #db2777 0%, #be185d 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'rgba(255, 245, 248, 0.94)', incomingTextColor: '#831843', chatBg: 'transparent', accentColor: '#db2777', inputBorderColor: '#db2777', reactionAccent: '#db2777', previewWallpaper: '/Floral.jpg', wallpaperUrl: '/Floral.jpg' },
  { id: 'sakura', name: 'Sakura', category: 'Special', outgoingGradient: 'linear-gradient(135deg, #e11d48 0%, #9f1239 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'rgba(255, 238, 242, 0.94)', incomingTextColor: '#881337', chatBg: 'transparent', accentColor: '#f43f5e', inputBorderColor: '#f43f5e', reactionAccent: '#f43f5e', previewWallpaper: '/Sakura.jpg', wallpaperUrl: '/Sakura.jpg' },
  { id: 'lilac', name: 'Lilac', category: 'Special', outgoingGradient: 'linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'rgba(255, 252, 245, 0.94)', incomingTextColor: '#4c1d95', chatBg: 'transparent', accentColor: '#8b5cf6', inputBorderColor: '#8b5cf6', reactionAccent: '#8b5cf6', previewWallpaper: '/Lilac.jpg', wallpaperUrl: '/Lilac.jpg' },
  { id: 'moon', name: 'Moon', category: 'Special', outgoingGradient: 'linear-gradient(135deg, #0d9488 0%, #0f766e 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'rgba(240, 253, 250, 0.94)', incomingTextColor: '#134e4a', chatBg: 'transparent', accentColor: '#0d9488', inputBorderColor: '#0d9488', reactionAccent: '#0d9488', previewWallpaper: '/Moon.jpg', wallpaperUrl: '/Moon.jpg' },
];
