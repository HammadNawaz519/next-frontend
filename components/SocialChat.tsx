...
export const INSTAGRAM_THEMES: ChatTheme[] = [
  ...
  { id: 'sea-side', name: 'Sea Side', category: 'Special', outgoingGradient: 'linear-gradient(135deg, #0ea5e9 0%, #0284c7 50%, #0369a1 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: '#0c2e4e', incomingTextColor: '#ffffff', chatBg: 'transparent', accentColor: '#38bdf8', inputBorderColor: '#38bdf8', reactionAccent: '#38bdf8', previewWallpaper: '/sea-side.jpg', wallpaperUrl: '/sea-side.jpg' },
];
