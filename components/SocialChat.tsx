          ...
          >
            {selectedUser ? (
              <>
                ...
                {replyToMessage && (
                  <div className="mx-2 mb-1.5 p-2.5 rounded-2xl border border-[var(--dm-border)] bg-[var(--dm-bg-hover)] flex items-center justify-between animate-in slide-in-from-bottom-2 duration-200">
                ...
                {selectedMessageIds.size === 0 ? (
                  <footer className="footer" style={{ borderTop: 'none', background: 'transparent', padding: '4px 10px 8px' }}>
