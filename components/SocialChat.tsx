...
export const INSTAGRAM_THEMES: ChatTheme[] = [
  ...
  { id: 'sunset-glow', name: 'Sunset Glow', category: 'Gradients', outgoingGradient: 'linear-gradient(135deg, #f97316 0%, #ec4899 50%, #8b5cf6 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#ec4899', inputBorderColor: '#ec4899', reactionAccent: '#f97316', previewWallpaper: 'linear-gradient(135deg, #f97316 0%, #ec4899 50%, #8b5cf6 100%)' },
  { id: 'cyberpunk', name: 'Cyberpunk', category: 'Gradients', outgoingGradient: 'linear-gradient(135deg, #06b6d4 0%, #3b82f6 50%, #d946ef 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#06b6d4', inputBorderColor: '#06b6d4', reactionAccent: '#d946ef', previewWallpaper: 'linear-gradient(135deg, #06b6d4 0%, #3b82f6 50%, #d946ef 100%)' },
  { id: 'neon-violet', name: 'Neon Violet', category: 'Gradients', outgoingGradient: 'linear-gradient(135deg, #a855f7 0%, #6366f1 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#a855f7', inputBorderColor: '#a855f7', reactionAccent: '#a855f7', previewWallpaper: 'linear-gradient(135deg, #a855f7 0%, #6366f1 100%)' },
  { id: 'emerald', name: 'Emerald', category: 'Ambient', outgoingGradient: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#10b981', inputBorderColor: '#10b981', reactionAccent: '#10b981', previewWallpaper: 'linear-gradient(135deg, #10b981 0%, #059669 100%)' },
  { id: 'rose-gold', name: 'Rose Gold', category: 'Gradients', outgoingGradient: 'linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #e11d48 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#f43f5e', inputBorderColor: '#f43f5e', reactionAccent: '#fb7185', previewWallpaper: 'linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #e11d48 100%)' },
  { id: 'ocean-breeze', name: 'Ocean Breeze', category: 'Ambient', outgoingGradient: 'linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#0ea5e9', inputBorderColor: '#0ea5e9', reactionAccent: '#0ea5e9', previewWallpaper: 'linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%)' },
  { id: 'midnight', name: 'Midnight', category: 'Ambient', outgoingGradient: 'linear-gradient(135deg, #312e81 0%, #1e1b4b 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: '#1e1b4b', incomingTextColor: '#e0e7ff', chatBg: 'var(--dm-bg-main)', accentColor: '#818cf8', inputBorderColor: '#4338ca', reactionAccent: '#818cf8', previewWallpaper: 'linear-gradient(135deg, #312e81 0%, #1e1b4b 100%)' },
  { id: 'lavender', name: 'Lavender', category: 'Gradients', outgoingGradient: 'linear-gradient(135deg, #c084fc 0%, #e879f9 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#c084fc', inputBorderColor: '#c084fc', reactionAccent: '#e879f9', previewWallpaper: 'linear-gradient(135deg, #c084fc 0%, #e879f9 100%)' },
  { id: 'solar-flare', name: 'Solar Flare', category: 'Gradients', outgoingGradient: 'linear-gradient(135deg, #f59e0b 0%, #ef4444 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#f59e0b', inputBorderColor: '#f59e0b', reactionAccent: '#ef4444', previewWallpaper: 'linear-gradient(135deg, #f59e0b 0%, #ef4444 100%)' },
  { id: 'candy-pop', name: 'Candy Pop', category: 'Gradients', outgoingGradient: 'linear-gradient(135deg, #f472b6 0%, #38bdf8 100%)', outgoingTextColor: '#ffffff', incomingBubbleColor: 'var(--dm-bg-hover)', incomingTextColor: 'var(--dm-text-primary)', chatBg: 'var(--dm-bg-main)', accentColor: '#f472b6', inputBorderColor: '#f472b6', reactionAccent: '#38bdf8', previewWallpaper: 'linear-gradient(135deg, #f472b6 0%, #38bdf8 100%)' },
